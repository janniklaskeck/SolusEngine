...
#include "utils/font/utf8.h"
#include "utils/font/cube_atlas.h"

#include "utils/font/shaders/vs_font_basic.bin.h"
#include "utils/font/shaders/fs_font_basic.bin.h"
#include "utils/font/shaders/vs_font_distance_field.bin.h"
#include "utils/font/shaders/fs_font_distance_field.bin.h"
#include "utils/font/shaders/vs_font_distance_field_subpixel.bin.h"
#include "utils/font/shaders/fs_font_distance_field_subpixel.bin.h"
#include "utils/font/shaders/vs_font_distance_field_outline.bin.h"
#include "utils/font/shaders/fs_font_distance_field_outline.bin.h"
#include "utils/font/shaders/vs_font_distance_field_outline_image.bin.h"
#include "utils/font/shaders/fs_font_distance_field_outline_image.bin.h"
#include "utils/font/shaders/vs_font_distance_field_drop_shadow.bin.h"
#include "utils/font/shaders/fs_font_distance_field_drop_shadow.bin.h"
#include "utils/font/shaders/vs_font_distance_field_drop_shadow_image.bin.h"
#include "utils/font/shaders/fs_font_distance_field_drop_shadow_image.bin.h"
#include "utils/font/shaders/vs_font_distance_field_outline_drop_shadow_image.bin.h"
#include "utils/font/shaders/fs_font_distance_field_outline_drop_shadow_image.bin.h"
...
public:
	...
	TextBuffer(SFontManager* _fontManager);
	~TextBuffer();
...
TextBuffer::TextBuffer(SFontManager* _fontManager)
...
STextBufferManager::STextBufferManager(SFontManager* _fontManager)
	: m_fontManager(_fontManager)
{
...
STextBufferManager::~STextBufferManager()
{
	BX_ASSERT(
...
TextBufferHandle STextBufferManager::createTextBuffer(uint32_t _type, BufferType::Enum _bufferType)
{
...
void STextBufferManager::destroyTextBuffer(TextBufferHandle _handle)
{
...
void STextBufferManager::submitTextBuffer(TextBufferHandle _handle, bgfx::ViewId _id, int32_t _depth)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
...
void STextBufferManager::setStyle(TextBufferHandle _handle, uint32_t _flags)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setTextColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setBackgroundColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setOverlineColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setUnderlineColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setStrikeThroughColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setOutlineColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setOutlineWidth(TextBufferHandle _handle, float _outlineWidth)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setDropShadowColor(TextBufferHandle _handle, uint32_t _rgba)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setDropShadowOffset(TextBufferHandle _handle, float _u, float _v)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setDropShadowSoftener(TextBufferHandle _handle, float smoother)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::setPenPosition(TextBufferHandle _handle, float _x, float _y)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::appendText(TextBufferHandle _handle, FontHandle _fontHandle, const char* _string, const char* _end)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::appendText(TextBufferHandle _handle, FontHandle _fontHandle, const wchar_t* _string, const wchar_t* _end)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
	bc.textBuffer->appendText(_fontHandle, _string, _end);
...
void STextBufferManager::appendAtlasFace(TextBufferHandle _handle, uint16_t _faceIndex)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
void STextBufferManager::clearTextBuffer(TextBufferHandle _handle)
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
...
TextRectangle STextBufferManager::getRectangle(TextBufferHandle _handle) const
{
	BX_ASSERT(isValid(_handle), "Invalid handle used");
	BufferCache& bc = m_textBuffers[_handle.idx];
